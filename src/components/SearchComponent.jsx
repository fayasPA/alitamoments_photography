  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        className="text-gray-300 text-5xl md:text-8xl font-bold tracking-wide text-left mb-1 md:mb-4 w-full bg-transparent focus:outline-none placeholder-gray-200 transition-all ml-4 md:ml-5"
